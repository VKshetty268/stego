      ...
      <div className="w-[95%] max-w-5xl bg-gray-900 text-white rounded-2xl shadow-lg p-6 flex flex-col gap-6">
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-md flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <div className="text-center">
              <p className="text-2xl font-bold text-green-400">{stats.scansToday}</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-800 p-4 rounded-xl shadow-md flex flex-col items-center cursor-pointer hover:bg-gray-700 border border-dashed border-gray-600">
        ...
        <div className="bg-yellow-600 p-5 rounded-xl shadow-md flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="text-sm text-yellow-100">Auto-scan & real-time protection</p>
          </div>
          <button className="mt-3 md:mt-0 px-6 py-2 bg-gray-900 rounded-lg hover:bg-gray-800">
            Upgrade
          </button>
        </div>
      </div>
